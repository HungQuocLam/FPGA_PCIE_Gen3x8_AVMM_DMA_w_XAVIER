...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "top_onchip_memory2_0.top_onchip_memory2_0"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/ebots/intelFPGA_pro/19.2/quartus/"
}
...
append ELAB_OPTIONS [subst [top_onchip_memory2_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [top_onchip_memory2_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
set logical_libraries [list "work" "work_lib" "altera_ver" "lpm_ver" "sgate_ver" "altera_mf_ver" "altera_lnsim_ver" "twentynm_ver" "twentynm_hssi_ver" "twentynm_hip_ver"]
...
set design_libraries [dict merge $design_libraries [top_onchip_memory2_0::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [top_onchip_memory2_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [top_onchip_memory2_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
