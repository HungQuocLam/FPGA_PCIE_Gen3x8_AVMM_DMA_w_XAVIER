	top_onchip_memory2_0 u0 (
		...
		.readdata    (_connected_to_readdata_),    //  output,  width = 256,       .readdata
		.writedata   (_connected_to_writedata_),   //   input,  width = 256,       .writedata
		.byteenable  (_connected_to_byteenable_),  //   input,   width = 32,       .byteenable
		...
		.readdata2   (_connected_to_readdata2_),   //  output,  width = 256,       .readdata
		.writedata2  (_connected_to_writedata2_),  //   input,  width = 256,       .writedata
		.byteenable2 (_connected_to_byteenable2_), //   input,   width = 32,       .byteenable
