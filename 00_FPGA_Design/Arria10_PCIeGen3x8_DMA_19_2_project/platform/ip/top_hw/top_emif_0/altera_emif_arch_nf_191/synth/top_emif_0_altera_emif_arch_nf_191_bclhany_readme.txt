...
---------------------
 ...
 16. Reset interface for the core master logic that interacts with the sequencer CPU
 17. Clock interface for the core master logic that interacts with the sequencer CPU
 18. Reset interface for the core slave logic that interacts with the sequencer CPU
 19. Clock interface for the core slave logic that interacts with the sequencer CPU
 20. User calibration debug clock domain reset interface
 21. User calibration debug clock interface
 22. Controller Avalon Memory-Mapped interface 0
 23. Calibration debug interface
 24. Interface that allows the EMIF calibration processor to talk to its slave components
 25. Instantiating IP in a simulation project
 26. Full-calibration versus skip-calibration simulation
 27. IP Settings
 28. Configuring the Traffic Generator
...
------------------------
   ...
   This is the readme file for the Intel External Memory Interface (EMIF) IP v19.1.
...
----------------------
   ...
   --------------------------------------------
      ...
      Address/command pinout scheme  : DDR4 Scheme 4: Component/UDIMM/RDIMM
...
----------------------------------------------------------------------------------------
   ...
   Port                           Width   Direction   Description                                        
   ------------------------------------------------------------------------------------------------------
   cal_master_reset_n             1       output      Reset for the core master logic that interacts with the sequencer CPU. Asynchronous assertion and synchronous deassertion
...
----------------------------------------------------------------------------------------
   ...
   Port                           Width   Direction   Description                                        
   ------------------------------------------------------------------------------------------------------
   cal_master_clk                 1       output      Clock for the core master logic that interacts with the sequencer CPU.
...
------------------------------------------------------------
   ...
   Port                           Width   Direction   Description                                        
   ------------------------------------------------------------------------------------------------------
   cal_debug_reset_n              1       input       Reset for the user clock connecting to the Avalon calibration debug bus. Asynchronous assertion and synchronous deassertion
...
-----------------------------------------------
   ...
   Port                           Width   Direction   Description                                        
   ------------------------------------------------------------------------------------------------------
   cal_debug_clk                  1       input       User clock domain
...
----------------------------------------------------
   ...
   amm_address_0                  22      input       Address for the read/write request
   ...
   Interface properties:
      ...
      WORD_ADDRESS_WIDTH            : 22
      SYMBOL_ADDRESS_WIDTH          : 28
      BURST_COUNT_WIDTH             : 7
...
------------------------------------
   ...
   Port                           Width   Direction   Description                                        
   ------------------------------------------------------------------------------------------------------
   cal_debug_waitrequest          1       output      Wait-request is asserted when controller is busy
   cal_debug_read                 1       input       Read request signal
   cal_debug_write                1       input       Write request signal
   cal_debug_addr                 24      input       Address for the read/write request
   cal_debug_read_data            32      output      Read data
   cal_debug_write_data           32      input       Write data
   cal_debug_byteenable           4       input       Byte-enable for write data
   cal_debug_read_data_valid      1       output      Indicates whether read data is valid
...
--------------------
   ...
   SYS_INFO_DEVICE                                   : 10AX115S2F45I1SG
   SYS_INFO_DEVICE_SPEEDGRADE                        : 1
   SYS_INFO_DEVICE_TEMPERATURE_GRADE                 : INDUSTRIAL
   SYS_INFO_DEVICE_POWER_MODEL                       : STANDARD
   ...
   SYS_INFO_UNIQUE_ID                                : top_emif_0_emif_0
   PREV_PROTOCOL_ENUM                                : PROTOCOL_DDR4
   PHY_FPGA_SPEEDGRADE_GUI                           : I1 (Production) - change device under 'View'->'Device Family'
   PHY_TARGET_SPEEDGRADE                             : I1
   ...
   PHY_DDR4_USER_DLL_CORE_UPDN_EN                    : false
   ...
   MEM_DDR4_IDEAL_VREF_OUT_PCT                       : 72.9
   ...
   MEM_DDR4_MR2                                      : 0x20030
   MEM_DDR4_MR3                                      : 0x30400
   MEM_DDR4_MR4                                      : 0x40800
   MEM_DDR4_MR5                                      : 0x50420
   MEM_DDR4_MR6                                      : 0x60813
   ...
   MEM_DDR4_TRCD_CYC                                 : 16
   MEM_DDR4_TRP_CYC                                  : 16
   MEM_DDR4_TRFC_CYC                                 : 278
   MEM_DDR4_TWR_CYC                                  : 18
   MEM_DDR4_TRTP_CYC                                 : 9
   MEM_DDR4_TFAW_CYC                                 : 23
   ...
   EX_DESIGN_GUI_DDR4_GEN_SIM                        : false
   EX_DESIGN_GUI_DDR4_GEN_SYNTH                      : false
