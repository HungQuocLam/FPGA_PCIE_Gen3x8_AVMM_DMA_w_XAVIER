...
module altera_emif_arch_nf_io_tiles #(
   ...
   logic [NUM_OF_RTL_TILES-1:0][LANES_PER_TILE-1:0][2:0]    all_tiles_dll_core_updn;
   ...
   generate
      ...
      begin: tile_gen
         ...
         begin: lane_gen
            ...
            assign all_tiles_dll_core_updn[tile_i][lane_i] = PHY_DLL_CORE_UPDN_EN  ? {core2dll[2],all_tiles_dll_core[tile_i][lane_i][12:11]} : core2dll;
