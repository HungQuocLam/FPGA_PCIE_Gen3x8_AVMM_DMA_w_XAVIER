...
set_false_path -from *altpcie_a10_hip_hwtcl|sync_rst* -to *altera_emif_arch_nf*
...
set_false_path -from [get_ports {perstn_perstn}]

set_false_path -to [get_ports {dk_alive_led}]
set_false_path -from [get_registers {top_hw|rst_controller_001|alt_rst_sync_uq1|altera_reset_synchronizer_int_chain_out}] -to *
set_false_path -from [get_registers {top_hw|rst_controller|alt_rst_sync_uq1|altera_reset_synchronizer_int_chain_out}] -to *
